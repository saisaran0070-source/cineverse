...
// === UI Animations (Smooth Scroll & Reveals) ===
function initAnimations() {
    ...
    if (typeof ScrollReveal !== 'undefined') {
        ...
        sr.reveal('.movie-grid', { delay: 200, origin: 'bottom' });
        sr.reveal('.movie-row', { delay: 200, origin: 'bottom' });
        sr.reveal('.genre-card', { interval: 100, origin: 'bottom' });
    }
    ...
    window.addEventListener('scroll', () => {
        ...
        // Background blur logic (already handled partially by .scrolled, but we enforce it here)
...
// Initialize animations immediately or wait for DOM load depending on script position
